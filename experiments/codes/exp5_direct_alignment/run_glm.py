"""
exp5_direct_alignment: Direct multimodal clip-to-sentence alignment with GLM-4.6V-Flash.
...
Frame budget per shot: one representative frame per shot.
...
def main():
    ...
    stem     = f"direct_{model_tag}_{args.dataset}_seed{args.seed}_{timestamp}"
