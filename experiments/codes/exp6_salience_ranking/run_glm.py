"""
exp6_salience_ranking: Shot salience ranking with GLM-4.6V-Flash.
...
Environment: GLM
Usage:
    python run_glm.py --dataset summe
    python run_glm.py --dataset summe --with_doc
    python run_glm.py --dataset summe --video video_1  # smoke test
"""
...
def main():
    ...
    stem     = f"{model_tag}_{args.dataset}{doc_tag}_seed{args.seed}_{timestamp}"
